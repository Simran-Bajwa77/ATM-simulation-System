...
public class Transactions extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource()==b1){ 
            ...
            //JOptionPane.showMessageDialog(null,"Cannot print your statement");
            ...
            try {
                ...
                ResultSet rs = c1.s.executeQuery(" SELECT balance FROM bank where pin  = '"+pinn+"'ORDER BY pin DESC");// LIMIT 1");
