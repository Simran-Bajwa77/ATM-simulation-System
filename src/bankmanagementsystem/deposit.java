        ...
        try{        
            ...
            if(ae.getSource()==b1){
                if(t1.getText().equals("") ||t2.getText().equals("")){
                    ...
                    JOptionPane.showMessageDialog(null, "MISSING Amount you want to Deposit OR pin");
                    ...
                    JOptionPane.showMessageDialog(null, "Rs. "+a+" Deposited Successfully AND your balance is "+balance+"\n");
