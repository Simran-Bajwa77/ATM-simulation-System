        ...
        try{        
            ...
            if(ae.getSource()==b1){
                if(t1.getText().equals("")||t2.getText().equals("")){
                    ...
                    JOptionPane.showMessageDialog(null, "MISSING Amount you want to Withdraw OR pin ");
                    ...
                    if(rs.next()){
                        ...
                        if(d>10000)
                                {
                                 JOptionPane.showMessageDialog(null,"Withdrawal limit Exceed");
                                }
                        else{
                        String q1= "insert into bank values('"+pin+"',null,'"+d+"','"+balance+"')";
                    
                        c1.s.executeUpdate(q1);
                        JOptionPane.showMessageDialog(null, "Rs. "+a+" Debited Successfully AND your balance is "+balance+"\n");
